module InitialPermutation (
  input logic [63:0] des_data, // Dữ liệu đầu vào
  input wire [3:0] r_counter, // Counter vòng lặp
  input wire encipher_process, rkey_sel, // Tín hiệu điều khiển
  input wire [31:0] ln, rn, // Dữ liệu bên trái và phải của vòng trước
  output logic [31:0] l_input, r_input // Kết quả l_input, r_input
);
  // Nội bộ
  wire [63:0] ip_input;
  wire [31:0] l0, r0;
  ...
  // Quyết định giá trị đầu vào L và R
